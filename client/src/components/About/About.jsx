    ...
    <div className="about" id="about">
      ...
      <div className="about-right">
        ...
        <p>
          ...
          at ease as you discover our diverse resources. <br /> As you explore our
          website, experience the warmth of our sincere approach, which puts
          your needs first and helps build a connection that will support your
          path to personal growth and success.
          <br /> Our commitment to excellence is
          evident in the wide range of courses we provide, catering to diverse
          interests and skill levels.
           Our team of dedicated professionals is
          always ready to assist and guide you, ensuring your journey towards
          self-improvement is both enjoyable and fruitful.
        </p>
      </div>
    </div>
  );
